...
def run_linear(
    ...
    _weights = weights.T
    linear.load_state_dict({"weight": _weights})
...
def run_swiglu(
    ...
    from cs336_basics.positionwise_feedforward import run_swiglu as _run_swiglu
    return _run_swiglu(d_model, d_ff, w1_weight, w2_weight, w3_weight, in_features)
...
def run_rope(
    ...
    rope = RoPE(d_k, theta, max_seq_len, device = in_query_or_key.device)
...
def run_transformer_block(
    ...
    """
    from cs336_basics.transformer import run_transformer_block as _run_transformer_block
    return _run_transformer_block(
        d_model=d_model,
        num_heads=num_heads,
        d_ff=d_ff,
        max_seq_len=max_seq_len,
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.data_loading import save_checkpoint
